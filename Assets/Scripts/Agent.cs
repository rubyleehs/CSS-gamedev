...
public abstract class Agent : MonoBehaviour
{
    ...
    public void Face(Vector2Int direction)
    {
        ...
        this.transform.rotation = Quaternion.Euler(Vector3.forward * Vector2.SignedAngle(Vector2.right, direction));
    }
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if(agentInteractable != null && agentInteractable.CanInteract(this))
        {
